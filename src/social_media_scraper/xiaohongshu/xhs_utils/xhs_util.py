...
import execjs
import os
from social_media_scraper.xiaohongshu.xhs_utils.cookie_util import trans_cookies

# JS files are in the js directory relative to this file
current_dir = os.path.dirname(__file__)
js_path_main = os.path.join(current_dir, '../js/xhs_main_260411.js')
js_path_xray = os.path.join(current_dir, '../js/xhs_xray.js')

js = execjs.compile(open(js_path_main, 'r', encoding='utf-8').read())
xray_js = execjs.compile(open(js_path_xray, 'r', encoding='utf-8').read())
