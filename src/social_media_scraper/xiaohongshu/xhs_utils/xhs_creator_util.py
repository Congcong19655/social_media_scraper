...
js_path_creator = os.path.join(current_dir, '../js/xhs_creator_260411.js')
js_path_signature = os.path.join(current_dir, '../js/xhs_creator_signature.js')
js_path_sign = os.path.join(current_dir, '../js/xhs_creator_sign.js')

js = execjs.compile(open(js_path_creator, 'r', encoding='utf-8').read())
signature_js = execjs.compile(open(js_path_signature, 'r', encoding='utf-8').read())
sign_js = execjs.compile(open(js_path_sign, 'r', encoding='utf-8').read())
